  ...
  const chartData = useMemo(() => {
    ...
    for (let d = -BACK; d <= FWD; d++) {
      ...
      if (isPast) {
        ...
        points.push({ label: getDayMonth(date), date, real: runningReal, projetado: runningProjected, isToday: d === 0 });
      } else {
        ...
        points.push({ label: getDayMonth(date), date, real: null, projetado: runningProjected, isToday: false });
      }
    }
