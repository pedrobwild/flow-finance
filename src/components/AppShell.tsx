...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="sm:hidden">
              ...
              >
                <SelectTrigger className={cn(
                  'h-8 w-[140px] text-[11px] border-dashed',
                  selectedObraId && 'border-primary/50 bg-primary/5'
                )}>
                ...
                <SelectContent>
                  <SelectItem value="__all__" className="text-xs font-medium">Todas</SelectItem>
                  {activeObras.map(o => (
                    <SelectItem key={o.id} value={o.id} className="text-xs">
                      {o.code}
                    </SelectItem>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 pb-24 lg:pb-6">{children}</main>
